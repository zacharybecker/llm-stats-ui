...
import { useRefreshConfig, useUIConfig } from "@/hooks/useModels";
...
const navItems = [
  ...
  { path: "/leaderboard", label: "Leaderboard", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
];
...
export function AppLayout() {
  ...
  const appName = uiConfig?.appName || "Model Stats";
      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex h-14 items-center px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            >
              {refreshMutation.isPending ? "Refreshing..." : "Refresh Config"}
            </Button>
          </div>
        </div>
      </header>
